...
T_synced = table(master_time_seconds, ...
                 ...
                 dataTableHTC.("message_pose_attitude_deg_0_"), ... %SALVO SOLO ANGOLI IN GRADI, LI ALTRI 3 SONO IN RADIANTI
...
T_synced.Properties.VariableNames = {'Tempo [s]', 'X_HTC [mm]', 'Y_HTC [mm]', 'Z_HTC [mm]','DegX_HTC [deg]', 'DegY_HTC [deg]', 'DegZ_HTC [deg]', ...
    'X_RS [mm]', 'Y_RS [mm]', 'Z_RS [mm]','DegX_RS [deg]', 'DegY_RS [deg]', 'DegZ_RS [deg]', ...
    ...
    'DegLeft_ENC [deg]', 'DegRight_ENC [deg]' };
